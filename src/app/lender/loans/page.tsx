...
import { RefreshCw, PlusCircle, CheckCircle2, XCircle, User, DollarSign, Calendar, FileText, AlertCircle, Eye, PieChart, TrendingUp, CheckCircle } from "lucide-react";
            ...
            <Card className="p-6 bg-white border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-sm text-gray-500 font-medium mb-2">Total Loans</p>
            ...
            <Card className="p-6 bg-white border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-3xl font-bold text-gray-900">
                    {statsLoading ? "..." : (loanStats as any)?.approved_loans ?? 0}
                  </p>
                </div>
                <div className="flex-shrink-0">
            ...
            <Card className="p-6 bg-white border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-3xl font-bold text-gray-900">
                    {statsLoading ? "..." : loanStats?.completed_loans ?? 0}
                  </p>
                </div>
                <div className="flex-shrink-0">
